...
public class CreateView extends javax.swing.JFrame {
    ...
    private void btn_createActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_createActionPerformed
        // TODO add your handling code here:
        this.cc.sendClientMessage("Do nothing!");
        ...
        this.cc.sendClientMessage(""+room_id);
        String msg_server = (String) cc.receiveServerMessage(); // Check room id
        if (msg_server.equals("Room id existed!")) {
            ...
            this.cc.sendClientMessage(room_pass);
            this.cc.sendClientMessage("Member created room!");
            msg_server = (String) cc.receiveServerMessage();
